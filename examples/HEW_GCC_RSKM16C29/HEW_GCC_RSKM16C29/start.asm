...
_start:
		...
		ldc 	#0xFD00, intbl	  /* load lower 16 bits of variable vector address in intbl */
...
/* Zero out fbss section */
		...
		push.w  #%hi16(_efbss)   	/* offset of -6 from fb: higher 16 bits of _efbss */
